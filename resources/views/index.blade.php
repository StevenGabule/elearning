...
@section('content')
    ...
    <div class="container">
        <h5 class="my-4 pink">TRENDING TECHNOLOGIES</h5>
        <div class="row row-cols-1 row-cols-md-4">
            @forelse($courses as $course)
                @if($course->category && $course->category->name != null)
                    <div class="col mb-4" style="display: flex;flex-flow: row wrap">
                        <div class="card border-0 shadow-sm rounded-0" style="background: #222222">
                            <img
                                src="{{ $course->image != null ? asset('storage/uploads/courses/thumbnail') . '/' . $course->image : asset('images/frontend/no-image-found.png') }}"
